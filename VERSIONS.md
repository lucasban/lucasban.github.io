...
### Shared Resources
- `shared/detector-base.css` → **v=3** (Added confetti base styles and animation)
- `shared/detector-utils.js` → **v=3** (Added initDecoration easter egg handler)
...
### Demo Resources
- `demos/canvas/plant/plant.js` → **v=3** (Added seasonal themes, watering streak, milestone celebrations, interactive critter events)
